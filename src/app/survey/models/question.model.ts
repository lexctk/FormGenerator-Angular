...
export class Question {
  ...
  constructor (public id_question: number, public id_poll: number, public label: string, public description: string,
               ...
               public id_question_type: number, public id_question_dependency: number, public question_dependency_answer: string,
               public participant_type: string, public answers: Answer[], public type: string) { }
}
